...
from network.heads import LinearHead
...
parser.add_argument('--cos', type=str, default='step', help='cosine decay mechanism for learning rate')
parser.add_argument('--dataset', type=str, default='cifar10')
parser.add_argument('--epochs', type=int, default=100)
parser.add_argument('--batch_size', type=int, default=256)
parser.add_argument('--checkpoint', type=str, default='')
parser.add_argument('--gpuid', default='0', type=str, help='gpuid')
parser.add_argument('--save_dir', type=str, default='./results', help='path to save the t-sne image')
